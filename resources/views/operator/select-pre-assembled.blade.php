<x-app-layout>
    <div class="max-w-6xl h-fit mx-auto my-0 border border-gray-300 dark:border-gray-600 p-4 rounded shadow m-5">
        <form wire:submit.prevent="submit">
            ...
            <table class="w-full h-max-content border border-gray-400 dark:border-gray-600 text-sm">
                <thead class="bg-gray-200 dark:bg-gray-700 text-left block w-full">
                    <tr class="table w-full table-fixed text-white">
                        <th class="border border-gray-400 dark:border-gray-600 px-2 py-1 uppercase w-2/4">descrizione<br><span class="text-xs font-normal">(componenti necessari per l'assemblaggio)</span></th>
                        <th class="border border-gray-400 dark:border-gray-600 px-2 py-1 uppercase w-1/4">codice pre-assemblato<br><span class="text-xs">ONN WATER</span></th>
                        <th class="border border-gray-400 dark:border-gray-600 px-2 py-1 uppercase w-1/4"></th>
                    </tr>
                </thead>
                <tbody class="block max-h-[55vh] overflow-y-auto w-full">
                    @foreach ($preassembleds as $p)
                    <tr class="table w-full table-fixed text-white">
                        <td class="border border-gray-300 dark:border-gray-600 w-2/4 p-5 ">{{$p->padre_description}}</td>
                        <td class="border border-gray-300 dark:border-gray-600 w-1/4 px-2 py-1">{{$p->code}}</td>
                        <td class="border border-gray-300 dark:border-gray-600 w-1/4 p-0">
